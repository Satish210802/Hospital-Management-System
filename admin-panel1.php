...
<html lang="en">
  ...
  <a class="navbar-brand" href="#">HP Hospital </a>
...
.btn-primary{
  ...
  <body style="padding-top:50px;">
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 40%; padding-bottom: 20px;font-family: 'Times New Roman', sans-serif;"> WELCOME ADMIN </h3>
    <div class="row">
      ...
      <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">
        <form class="form-group" method="post" action="admin-panel1.php">
          <div class="row">
                  ...
                  <div class="col-md-8"><input type="text" class="form-control" name="doctor" onkeydown="return " required></div><br><br>
