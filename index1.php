...
<html lang="en">
  ...
  <body style="background-image: url(images/bgimg.jpg); background-size: cover;">
    ...
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="index.php" style="margin-top: 10px;margin-left:-65px;font-family: 'Times New Roman', sans-serif;"><h4>HP HOSPITALS</h4></a>
    ...
    animation: mover 1s infinite alternate;">
      ...
      <div style="color: white; padding-top: 15rem;">
            <h4 style="font-family: 'Times New Roman', sans-serif;"> We are here for you!</h4>
          </div>
